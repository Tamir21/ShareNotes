...
public class ChatMessageAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null)
        {
            ...
            {
                view = inflater.inflate(R.layout.list_sent_msgs,null);
                BubbleTextView bubbleTextView = (BubbleTextView)view.findViewById(R.id.msg_content);
                bubbleTextView.setText(qbChatMessages.get(position).getBody());
            }
            else
            {
                view = inflater.inflate(R.layout.list_recieved_msgs,null);
                BubbleTextView bubbleTextView = (BubbleTextView)view.findViewById(R.id.msg_content);
                bubbleTextView.setText(qbChatMessages.get(position).getBody());
